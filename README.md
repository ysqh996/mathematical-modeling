...
由于我们已知江西省各地市之间的日人口流动为1.5%，目的地与当地人口比例近似线性相关，可得

$Rp_{i} \times 1.5 \% = Ld_{i}$ (1)

$Ld_{i}=(Rp_1+ \dots + Rp_{i-1}+Rp_{i+1}+ \dots +Rp_{11}) \times K_{i}+(K_1+ \dots + K_{i-1}+K_{i+1}+ \dots +K_{11}) \times Rp_{i}$ (2)

$Trs_{i}=9a_i + 19b_i + 45c_i + 55d_i$ (3)

综合(1)和(2)式可利用`Gauss` 消元将各个城市的线性相关参数解($k_i$)出

| 地区 | 南昌| 赣州|宜春|吉安|上饶|抚州|九江|景德镇|萍乡|新余|鹰潭|
| :---        |    :----:   |  :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| 线性相关常数|0.00127257|	0.00210686	|0.00090088	|0.00077783	|0.00127234	|0.00060118	|0.00080769	|0.00024676	|0.00027742	|0.0001794	|0.00017204|
...
clear;
format long;
b=[643.75*0.015; 898*0.015 ;497.11*0.015; 442.51*0.015; 643.67*0.015 ;357.94*0.015  ;456.94*0.015; 162.06*0.015;  180.59*0.015; 120.21*0.015 ; 115.5*0.015];
A=[ 3873.66 643.75 643.75 643.75 643.75 643.75 643.75 643.75 643.75 643.75 643.75;
    898 3619.41 898 898 898 898 898 898 898 898 898; 
    497.11 497.11 4020.3 497.11 497.11 497.11 497.11 497.11 497.11 497.11 497.11 ;
    442.51 442.51 442.51 4074.9 442.51 442.51 442.51 442.51 442.51 442.51 442.51;
    643.67 643.67 643.67 643.67 3873.74 643.67 643.67  643.67 643.67 643.67 643.67; 
    357.94 357.94 357.94 357.94 357.94 4159.47 357.94  357.94 357.94 357.94 357.94;
    456.07 456.07 456.07 456.07 456.07 456.07 4061.34 456.07 456.07 456.07 456.07 ; 
    162.06 162.06 162.06 162.06 162.06 162.06 162.06 4355.35 162.06 162.06 162.06;
    180.59 180.59  180.59 180.59 180.59 180.59 180.59  180.59 4336.82  180.59 180.59 ; 
    120.21 120.21 120.21 120.21 120.21 120.21 120.21 120.21 120.21 4397.2 120.21 ;
    115.5 115.5 115.5 115.5 115.5 115.5 115.5 115.5 115.5 115.5 4401.91];
x=A\b;
x' %将结果输出为行向量
```
...
/*
0	429	210	237	276	105	150	282	270	189	147	
0	0	314	186	512	345	524	537	322	284	402	
0	0	0	150	392	214	336	392	64	72	297	
0	0	0	0	387	194	347	410	210	122	276	
0	0	0	0	0	196	332	200	452	337	113	
0	0	0	0	0	0	241	220	280	165	102	
0	0	0	0	0	0	0	140	389	280	276	
0	0	0	0	0	0	0	0	453	337	156	
0	0	0	0	0	0	0	0	0	120	360	
